...
## Project Structure
    ...
    ├── testapiautosetting_109682  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_109682`
...
2. Clone this repo and `cd testapiautosetting_109682`
